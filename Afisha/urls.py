...
from movie_app.views import directors_list_api_view, movies_list_api_view, review_list_api_view, director_detail_list_api_view, movie_detail_list_api_view, review_detail_list_api_view
